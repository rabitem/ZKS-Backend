...
<div class="cMainContentManageUsers" id = "cMainContentSubFolder">
    <div class="cAdjustments cMainBox">
        ...
        <div class="cOptions">
            <p>Grant Access</p>
            <svg id = "svgAddSignLocation" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p>Revoke Access</p>
            <svg id = "svgRemoveSignLocation" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
