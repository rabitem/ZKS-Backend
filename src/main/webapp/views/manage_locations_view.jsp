...
<div class="cMainContentManageUsers" id = "cMainContentSubFolder">
    <div class="cAdjustments cMainBox">
        ...
        <div class="cOptions">
            <p class = "svgBtnDescription">Add Location</p>
            <svg class = "svgAdd" id = "svgAddSignLocation" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p class = "svgBtnDescription">Remove Location</p>
