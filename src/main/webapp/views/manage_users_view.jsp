...
<div class="cMainContentManageUsers" id = "cMainContentSubFolder">
    <div class="cAdjustments cMainBox">
        ...
        <div class="cOptions">
            <p>Add Users</p>
            <svg class = "svgAdd" id = "svgAddSign" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="cTableContent cMainBox">
        ...
        <table>
            ...
            <c:forEach items="${users}" var="user">
                <tr class = "trCurData" id = "trData${user.name}" data-valueID = ${user.id}  data-name = ${user.name}>
                    <td>${user.name}</td>
